...
void ArgsParser::print_help(const char* program_name) {
  std::cout
      ...
      << "  --monitor <monitor target>  Specify the target to monitor.\n"
         "                              Valid targets are arm_cmn_mem_bw_all, arm_cmn_mem_bw_up and arm_cmn_mem_bw_down\n"
      << "  --cmn-mc-pos <cmn pos file> Specify the memory controller position file\n"
